...
sites = list(pd.read_csv('/home/kali/Desktop/Project/OpenWPM/datadir/sources/PersonaLinksMS.csv')['url_domain'])
...
browser_params = [BrowserParams(display_mode="headless", 
                                profile_archive_dir=Path("/home/kali/Desktop/Project/OpenWPM/datadir/Profiles")) #Specifies profile output
