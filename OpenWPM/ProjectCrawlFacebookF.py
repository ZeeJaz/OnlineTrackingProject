...
sites = list(pd.read_csv('/home/kali/Desktop/Project/OpenWPM/datadir/sources/Facebook Top 1000.csv')['url_domain']) # VISITED INDIEWIRE & TOPGEAR TWICE
...
for browser_param in browser_params:
    ...
    browser_param.seed_tar = Path('/home/kali/Desktop/Project/OpenWPM/datadir/Profiles/profileF.tar.gz')
